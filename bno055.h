...
void Get_Offsets(uint8_t *offsetData); // offset datasini offsetData degiskenine alir

void Set_Offsets(uint8_t* offsetData); // offset datasini registerlara yazarak kalibrasyon yapar

/** Veri olusturulduktan sonra pointer olarak return eder. Ornegin
 *
 * float *accel;
 * accel = Get_Accel_XYZ();
 * x = accel[0];
